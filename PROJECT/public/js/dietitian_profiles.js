const nutritionists = [
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const time = selectedSlot.textContent.trim();
    
    try {
        // Prepare booking data (without user ID)
        const bookingData = {
        ...
        if(response.ok){
           alert("Slot is Sucessfully Booked")
        }
        else {
        ...
        confirmation.innerHTML = `
            <div class="success-message">
                ...
                <p>Specailization: ${nutritionist.specialization}</p>
